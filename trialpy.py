...
title_lbl = Label(root, text="DeCODE Your Symptoms", font=("Bold italic", 35, "bold"), bg="cyan", fg="red")
...
# labels
name_lbl = Label(main_frame, text="Diagnosis At Your Fingertips! Select your Symptoms", font=("loma", 15, "bold"), fg="blanched almond", bg="purple")
name_lbl.place(x=100, y=10, width=800, height=50)

S1Lb = Label(main_frame, text="Symptom 1", font=("times and roman", 17, "bold"), fg="pink", bg="black")
S1Lb.place(x=50, y=70, width=250, height=50)

S2Lb = Label(main_frame, text="Symptom 2", font=("times and roman", 17, "bold"), fg="pink", bg="black")
S2Lb.place(x=50, y=130, width=250, height=50)

S3Lb = Label(main_frame, text="Symptom 3", font=("times and roman", 17, "bold"), fg="pink", bg="black")
S3Lb.place(x=50, y=190, width=250, height=50)

S4Lb = Label(main_frame, text="Symptom 4", font=("times and roman", 17, "bold"), fg="pink", bg="black")
S4Lb.place(x=50, y=250, width=250, height=50)

S5Lb = Label(main_frame, text="Symptom 5", font=("times and roman", 17, "bold"), fg="pink", bg="black")
S5Lb.place(x=50, y=310, width=250, height=50)

lrLb = Label(main_frame, text="OUTPUT", font=("times and roman", 17, "bold"), fg="white", bg="purple")
...
dst = Button(main_frame, text="DECRYPT", command=DecisionTree, font=("times and roman", 20, "bold"), bg="pink",
             fg="orange")
dst.place(x=50, y=390, width=400, height=100)
exit_button = Button(main_frame, text="EXIT", command=root.destroy,font=("times and roman", 20, "bold"), bg="red2",
             fg="yellow")
exit_button.place(x=500,y=390, width=400, height=100)
# textfileds
t1 = Text(main_frame, height=1, width=40, font=("times and roman", 15, "bold"), bg="yellow", fg="black")
t1.place(x=500, y=500, width=300, height=50)
